                            ...
                            <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Absternet LLC</td>
                                        <td>Sep 20, 2021</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                    ...
                                    <tr>
                                        <td>Raitech Soft</td>
                                        <td>Sep 23, 2021</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                    ...
                                    <tr>
                                        <td>William PVT</td>
                                        <td>Sep 27, 2021</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                    ...
                                    <tr>
                                        <td>Loiusee LLP</td>
                                        <td>Sep 30, 2021</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                    ...
                                    <tr>
                                        <td>Apple Inc.</td>
                                        <td>Sep 30, 2021</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                            <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a>
                                        </td>
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Jansh Brown">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Dan Gibson">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Nina Schmidt">
                                                    <img src="{{ asset('backend/assets/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item material-shadow">
                                                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>William PVT</td>
                                        <td><img src="{{ asset('backend/assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
